...
### Простое приложение для заметок, сохраняя их в виде текствого файла.
...
Приложение при запуске сразу помещается в трэй и на панели задачь не видно, - идеально для автозапуска.
...
Так-же, для тех кто привык все делать мышкой, то можно кликнуть ЛКМ на иконку в трее, и выбрать соответстующее меню.
